	  ...
	  return function (_ref) {
	    ...
	    return function (next) {
	      return function (action) {
	        ...
	        (0, _core2.default)(logBuffer, _extends({}, loggerOptions, { diff: diff }));
	        logBuffer.length = 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getDiffCollapsed(diffOptions) {
	  if (diffOptions && (typeof diffOptions === 'undefined' ? 'undefined' : _typeof(diffOptions)) === 'object' && typeof diffOptions.collapsed === 'boolean') {
	...
	function getDiffPrefilter(diffOptions) {
	  if (diffOptions && (typeof diffOptions === 'undefined' ? 'undefined' : _typeof(diffOptions)) === 'object' && (typeof diffOptions.prefilter === 'function' || _typeof(diffOptions.prefilter) === 'object')) {
	...
	function printBuffer(buffer, options) {
	  ...
	  buffer.forEach(function (logEntry, key) {
	    ...
	    if (diff) {
	      var prefilter = getDiffPrefilter(diff);
	      var diffCollapsed = getDiffCollapsed(diff) || isCollapsed;
	      (0, _diff2.default)(prevState, nextState, logger, diffCollapsed, prefilter);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function diffLogger(prevState, newState, logger, isCollapsed, prefilter) {
	  var diff = (0, _deepDiff2.default)(prevState, newState, prefilter);
